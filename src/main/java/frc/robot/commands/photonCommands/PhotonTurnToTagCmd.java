...
public class PhotonTurnToTagCmd extends Command {
    ...
    public PhotonTurnToTagCmd(DriveSubsystem driveSubsystem, PhotonSubsystem photonSubsystem, boolean end) {
    ...
    public void initialize() {
        ...
        if (detectedTag != -1) { // Ensure a valid tag was detected
            ...
            double feederAngle = PHOTON_SUBSYSTEM.getFeederAngleForTag(detectedTag); // Get pre-defined feeder angle
