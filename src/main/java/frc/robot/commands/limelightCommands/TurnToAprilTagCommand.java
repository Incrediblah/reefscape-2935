...
public class TurnToAprilTagCommand extends Command {
    ...
    public TurnToAprilTagCommand(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem, boolean end) {
    ...
    public void initialize() {
        ...
        if (detectedTag != -1) { // Ensure a valid tag was detected
            ...
            double reefAngle = VISION_SUBSYSTEM.getReefAngleForTag(detectedTag); // Get pre-defined reef angle
