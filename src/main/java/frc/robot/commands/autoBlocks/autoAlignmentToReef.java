...
public class autoAlignmentToReef extends SequentialCommandGroup {
  ...
  public autoAlignmentToReef(DriveSubsystem drive, VisionSubsystem vision, ElevatorSubsystem elevator, ArmSubsystem arm, CoralIntakeSubsystem intake, String reefside) {
