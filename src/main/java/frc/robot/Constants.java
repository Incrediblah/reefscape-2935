...
public final class Constants {
  ...
  public static final class ElevatorConstants {
    ...
    public static final double kLevel4 = 64; //88
  ...
  public static final class ArmConstants {
    ...
    public static final double kFeederStation = 0.5; // -4
    public static final double kTravel = 0;

    public static final double kLevel1 = 0;
    public static final double kLevel2 = 0; //-7
    public static final double kLevel3 = 3.25;
    public static final double kLevel4 = 3.125; //84
  ...
  public static class VisionConstants {
    ...
    public static final double leftCamTagX = 2.67;
    public static final double leftCamTagY = -1.73;

    public static final double rightCamTagX = -16.4;
    public static final double rightCamTagY = -2.0;
