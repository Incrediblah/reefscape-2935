  ...
  private void configureBindings() {
    ...
    m_driverController.b().onTrue(
      ...
      new ParallelCommandGroup(
        new alignXandYRightCamera(s_driveSubsystem, s_VisionSubsystem, 0, false, 15, -4.5, 0.5, 0.5), 
        new MoveArmToSetpoint(s_ArmSubsystem, ArmConstants.kLevel4)
      )
    ); 
    ...
    m_driverController.b().onFalse(
      new ParallelDeadlineGroup(
        new alignXandYRightCamera(s_driveSubsystem, s_VisionSubsystem, 0, true, 7, -7, 0.5, 0.5), 
        new MoveArmToSetpoint(s_ArmSubsystem, ArmConstants.kHome)
      )
    ); 
    ...
    m_driverController.a().onTrue(
      ...
      new ParallelCommandGroup(
        new alignXandYLeftCamera(s_driveSubsystem, s_VisionSubsystem, 0, false, -16.5, -3, 0.5, 0.5), 
        new MoveArmToSetpoint(s_ArmSubsystem, ArmConstants.kLevel4)
      )
  ); 
    ...
    m_driverController.a().onFalse(
      new ParallelDeadlineGroup(
        new alignXandYLeftCamera(s_driveSubsystem, s_VisionSubsystem, 0, true, 7, -7, 0.5, 0.5), 
        new MoveArmToSetpoint(s_ArmSubsystem, ArmConstants.kHome)
      )
    ); 
