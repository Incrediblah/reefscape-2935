...
import frc.robot.commands.auto.onePieceRobotRight;
...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // new alignXandYRightCamera(s_driveSubsystem, s_VisionSubsystem, 0, false,  VisionConstants.rightCamTagX, VisionConstants.rightCamTagY, VisionConstants.xTol, VisionConstants.yTol)
      ...
      new autoAlignmentToReef(s_driveSubsystem, s_VisionSubsystem, s_ElevatorSubsystem, s_ArmSubsystem, s_CoralIntakeSubsystem, "right",false)
    ...
    m_driverController.a().onTrue(
      // new alignXandYLeftCamera(s_driveSubsystem, s_VisionSubsystem, 0, false,  VisionConstants.leftCamTagX, VisionConstants.leftCamTagY, VisionConstants.xTol, VisionConstants.yTol)
      // new autoScoreCoral(s_driveSubsystem, s_VisionSubsystem, s_ElevatorSubsystem, s_ArmSubsystem, s_CoralIntakeSubsystem, "left")
      ...
      // new AlignXandYWithPhoton(s_driveSubsystem, photon, false, -11, 42, 0, 0)
      // new PhotonAlignXandYCmd(s_driveSubsystem, photon, false, -11, 0)

      new autoAlignmentToReef(s_driveSubsystem, s_VisionSubsystem, s_ElevatorSubsystem, s_ArmSubsystem, s_CoralIntakeSubsystem, "left",false)
    ); 

    m_driverController.a().onFalse(
      // new ParallelCommandGroup(
      //   new alignXandYLeftCamera(s_driveSubsystem, s_VisionSubsystem, 0, true, -19.5, -0.25, 0.5, 0.5)
    ...
    m_driverController.x().onTrue(
      // new TurnToAprilTagCommand(s_driveSubsystem, s_VisionSubsystem, false)
      //new PhotonTurnToTagCmd(s_driveSubsystem, photon, false)
      new autoAlignmentToFeeder(s_driveSubsystem, photon,false)
    ); 

    m_driverController.x().onFalse(
      // new TurnToAprilTagCommand(s_driveSubsystem, s_VisionSubsystem, true)
      // new PhotonTurnToTagCmd(s_driveSubsystem, photon, true)
