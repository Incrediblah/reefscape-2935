...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_driverController.b().onTrue(
      ...
      new autoAlignmentToReef(s_driveSubsystem, s_VisionSubsystem, s_ElevatorSubsystem, s_ArmSubsystem, s_CoralIntakeSubsystem, "right")
    ...
    m_driverController.a().onTrue(
      ...
      new autoAlignmentToReef(s_driveSubsystem, s_VisionSubsystem, s_ElevatorSubsystem, s_ArmSubsystem, s_CoralIntakeSubsystem, "left")
    ...
    //   new TurnToAngleCommand(s_driveSubsystem, -90),
    //   new autoScoreCoral(s_driveSubsystem, s_VisionSubsystem, s_ElevatorSubsystem, s_ArmSubsystem, s_CoralIntakeSubsystem, "left")
    //   )
    //  );
    ...
    m_driverController.x().onTrue(
      ...
      new TurnToAngleCommand(s_driveSubsystem, -120)
    ); 
